...
if [ $IS_RELEASE -eq "1" ]; then
    ...
    docker build -t "$IMAGE_REPOSITORY/$PROJECT_NAME/$COMPONENT:$tag" . || exit 1
    ...
    curl --insecure "https://feedmachine.rorymcstay.com/updatemanager/rolloutImage/$COMPONENT/$tag/7201873fd83683026d53267fd3606471f51fdf68ad1b4da3709d3cf5f8e8f1f1"
    exit;
fi
